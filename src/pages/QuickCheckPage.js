...
//   const handleAddMore = () => {
//     alert('Add more claims or media (functionality to be implemented)');
//   };
...
//                     required
//                   />
//                   <button type="button" className="add-btn" onClick={handleAddMore}>
//                     +
//                   </button>
//                   <button type="submit" className="verify-button">
//                     {t.checkText}
    ...
    <div className="quick-check-page">
      <div className="container">
        {state === 'initial' && (
          <>
            <h1 className="title-h1">{t.quickCheckTitle}</h1>
            <p className="real-or-fake">IS IT REAL OR FAKE?</p>
            <p className="verify-now">Verify Now</p>
            <form onSubmit={handleSubmit} className="quick-check-form">
              <div className="input-container">
                <div className="input-wrapper">
                  ...
                  <div className="button-group">
                    <div className="left-buttons">
                      ...
                      <button type="button" className="offline-toggle" onClick={toggleOnlineStatus}>
                        <span className="offline-icon">☁</span> USE OFFLINE
                      </button>
                    </div>
                    <button type="submit" className="verify-button">
                      Verify
